---
title: "(General) Linear Models in R - Regression Analysis"
format:
  html:
    toc: true
    toc-location: left
...
# GLMs and GLMMs - Background <img src='Images/logo.png' align="right" height="138.5" /></a>
...
There are important options to chose within GLMs and GLMMs but as I mention they are more consistent and easier to check/adhere to their assumptions.
...
data <- tibble(x=c(0,250,300,400,0,100,-100,-200,200,275,350,200,0,-200,-350), 
               y=c(185,175,200,175,150,125,125,100,100,125,100,75,100,75,100),
               Type=c("Decision",
                      "Decision",
                      "Distribution",
                      "Distribution",
               ...
               Label=c('Is the Response\nVariable Numeric\nor Categorical?',
                       ...
                       'Gaussian',
                       'Beta')) %>% 
  dplyr::mutate(xbuffer=if_else(Type=="Decision",80,50),
                ybuffer=if_else(Type=="Decision",10,7))
...
data %>% 
  ...
  scale_x_continuous(limits=c(-400,450),
                     minor_breaks = seq(-400, 450, 10)) +
  scale_y_continuous(limits=c(60,215),
                     minor_breaks = seq(0, 225, 10)) +
  theme_linedraw() +
  statebins:::geom_rrect(aes(xmin = x-xbuffer, xmax=x+xbuffer, ymin=y-ybuffer, ymax=y+ybuffer,
  ...
  geom_text( aes(x= x, y=y,label= Label),
    ...
    +
  geom_segment(
    x=50, xend=100, y=180, yend=170, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=150, xend=100, y=180, yend=170, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=100, xend=50, y=150, yend=145, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=100, xend=150, y=150, yend=145, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=50, y=135, yend=130, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=50, y=120, yend=115, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=50, xend=50, y=105, yend=100, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=125, y=135, yend=130, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=125, xend=125, y=120, yend=115, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=125, xend=125, y=105, yend=100, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=175, y=135, yend=130, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=175, xend=175, y=105, yend=100, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=100, y=90, yend=85, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=150, xend=100, y=90, yend=85, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=100, xend=50, y=75, yend=70, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=100, xend=150, y=75, yend=70, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed")) +
  geom_segment(
    x=210, xend=130, y=80, yend=80, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=50, y=60, yend=35, 
    size=0.15)+
  geom_segment(
    x=50, xend=40, y=35, yend=40, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=40, y=35, yend=30, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=60, y=35, yend=40, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=50, xend=60, y=35, yend=30, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=150, y=60, yend=25, 
    size=0.15)+
  geom_segment(
    x=150, xend=140, y=25, yend=25, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=160, y=25, yend=25, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=140, y=25, yend=40, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=140, y=25, yend=10, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=160, y=25, yend=40, 
    size=0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(1, "mm"), type= "closed"))+
  geom_segment(
    x=150, xend=160, y=25, yend=10, 
    size=0.15, linejoin = "mitre", lineend = "butt",
...
Integer or Continous Numeric Data
:::
...
p2<-
  ...
  labs(x="Fish Length (mm)",
       y="",
       title = "Gamma")+
  scale_x_continuous(limits = c(-2,max(Forklength$x)*1.1))
...
p12<-ResidualsExample_df%>% 
  mutate(Residuals=(u-y)/sqrt(y))%>% 
  ggplot()+
  geom_histogram(aes(x=Residuals,y=after_stat(density)),linewidth=1,fill="darkcyan",alpha=0.9,colour="black")+ 
...
```
 ...
 Artwork of Penguins by @allison_horst
